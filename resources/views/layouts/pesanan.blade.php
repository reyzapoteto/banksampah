          ...
          <div class="card p-2 h-100 shadow-none border">
            ...
            <div class="card-body p-3 pt-2">
              <div class="d-flex justify-content-between align-items-start mb-3">
                <span class="badge bg-label-warning">{{ $transaksiBarang->barang->kategori_barang }}</span>   <span class="badge bg-label-primary">Barang Bekas</span>    <span class="badge bg-label-success">Terbayar</span>
              </div>
              <a class="h5">{{ $transaksiBarang->barang->nama_barang }}</a>
              <p class="mt-2">{{ $transaksiBarang->barang->deskripsi_barang }}.</p>
              <p class="mt-0"> Total Pembayaran : Rp {{ $transaksiBarang->total }}.</p>
              <p class="mt-0"> Kuantitas : {{ $transaksiBarang->quantity }} produk.</p>

              <a class="w-100 btn btn-label-success mt-4" href="https://api.whatsapp.com/send?phone=6281227533806"><i class="bx bx-phone-call me-2"></i>Hubungi Penujual</a>
            </div>
          </div>
        </div>
@endforeach
