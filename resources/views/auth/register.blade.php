                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ route('register') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold">BankSampah</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name="name"
                                    placeholder="Masukan nama username" autofocus />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms-conditions">
                                        Saya setuju dengan
                                        <a href="javascript:void(0);">Peraturan dan Ketentuan</a>
                                    </label>
                                </div>
                            </div>
